...
public final class AttributeRegistry {
    ...
    public static final EntityAttribute GENERIC_SWIM_SPEED = new ClampedEntityAttribute("attribute.name.generic.swim_speed", .03999999910593033d, 0d, 1024d).setTracked(true);
    ...
    // controls jump strength of entities
    ...
    public static void register() {
        ...
        Registry.register(Registries.ATTRIBUTE, new Identifier(CreoLib.NAMESPACE, "generic.jump_strength"), GENERIC_JUMP_STRENGTH);
